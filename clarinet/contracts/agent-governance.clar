...
(define-constant TOKEN_CONTRACT 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.agent-token)
(define-constant TREASURY_CONTRACT 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.agent-treasury)
...
;; Voting parameters
(define-constant VOTING_QUORUM u15)        ;; 15%
(define-constant VOTING_THRESHOLD u66)  ;; 66%
(define-constant CORE_CHANGE_THRESHOLD u95)  ;; 95%
(define-constant PROPOSAL_BOND u25000000000)
