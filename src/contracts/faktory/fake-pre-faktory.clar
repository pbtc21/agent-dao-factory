...
(define-constant VESTING-SCHEDULE
    ...
    ;; Token, Dex and sBTC
    (define-constant TOKEN-DAO 'SP2Z94F6QX847PMXTPJJ2ZCCN79JZDW3PJ4E6ZABY.fake-faktory) ;; param
    (define-constant DEX-DAO 'SP2Z94F6QX847PMXTPJJ2ZCCN79JZDW3PJ4E6ZABY.fake-faktory-dex) ;; param
 ...
 (define-read-only (get-max-seats-allowed)
  ...
  (define-private (initialize-token-distribution)
      (begin
          ...
          (try! (as-contract (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
                                    transfer MULTI-SIG-AMOUNT tx-sender FAKTORY1 none))) ;; 0.00010000 BTC  -> covers contract deployment gaz fees
          (try! (as-contract (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
                                    transfer FEE-AMOUNT tx-sender FAKTORY2 none)))  ;; 0.00140000 BTC fees -> covers ordinals bot, xlink and faktory
